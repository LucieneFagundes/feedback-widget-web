...
export function FeedbackContentStep({ feedbackType, onFeedbackRestartRequested, onFeedbackSent }: FeedbackContentStepProps) {
    ...
    // Esse estado pode ser uma string ou nulo, mas vai começar sendo nulo
    ...
    return (<>
        ...
        <form onSubmit={handleSubmitFeedback} className="my-4 w-full">
            <textarea
                ...
                focus:border-brand-500 focus:ring-band-500 focus:ring-1 focus:outline-none resize-none scrollbar scrollbar-thumb-zinc-700 scrollbar-track-transparent scrollbar-thin"
            ...
            <footer className="flex gap-2 mt-2">
                ...
                <button
                    type="submit"
                    //Se o comentário estiver vazio, o botão estará desabilitado
